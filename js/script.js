(() => {
    ...
    async function fetchOffers() {
        ...
        $.getJSON("https://d1cdbd1x576ga0.cloudfront.net/public/offers/feed.php?user_id=613818&api_key=a43692bb035f7349ccc668574c1f1e60&s1=&s2=&callback=?", function(offers) {
            if(loading) loading.style.display = "none";
            if(container) {
                container.style.display = "flex";
                container.innerHTML = "";
                
                let finalOffers = offers.slice(0, 3);
